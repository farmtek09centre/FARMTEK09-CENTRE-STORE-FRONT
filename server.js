...
app.get("/api/payment-config",(_req,res)=>res.json({
  storeName: process.env.STORE_NAME || "FARMTEK09 CENTRE",
  whatsappNumber: process.env.WHATSAPP_NUMBER || "254725528888",
  mpesaBusinessNumber: process.env.PAYBILL_BUSINESS || "400200",
  mpesaAccountNumber: process.env.PAYBILL_ACCOUNT || "54095",
  bankTransfer: {
    enabled: String(process.env.BANK_TRANSFER_ENABLED || "true").toLowerCase() === "true",
    bankName: process.env.BANK_NAME || "",
    accountName: process.env.BANK_ACCOUNT_NAME || "FARMTEK09 CENTRE",
    accountNumber: process.env.BANK_ACCOUNT_NUMBER || "",
    branch: process.env.BANK_BRANCH || "",
    branchCode: process.env.BANK_BRANCH_CODE || "",
    referencePrefix: process.env.BANK_REFERENCE_PREFIX || "FARMTEK09"
  }
}));
